        ...
        if (db.data.settings[botNumber].autobio) {
          ...
          if (new Date() * 1 - setting.status > 1000) {
            ...
            await ryozingod.updateProfileStatus(
              `✳️ PASCHAL BUG- Client By : PASCHAL💚  ✅ Runtime : ${uptime}`
            );
...
*/
        ...
        const moment = require("moment-timezone");
        const time = moment().tz("Afirca/Rivera").format("HH:mm:ss");
        let ucapanWaktu;
        ...
        const qevent = {
          ...
          message: {
            eventMessage: {
              isCanceled: false,
              name: "🌠 PASCHA-V1-BUG - Multi Device",
              description: "Pe",
              location: {
                degreesLatitude: 0,
                degreesLongitude: 0,
                      ...
                      interactiveMessage: {
                        ...
                        nativeFlowMessage: {
                          buttons: [
                            {
                              name: "cta_url",
                              buttonParamsJson: `{ display_text : 'ℙ𝔸𝕊ℂℍ𝔸𝕃 𝕍1 𝔹𝕌𝔾', url : "https://whatsapp.com/channel/0029VaYb7EyLNSZvA5A4iK2C", merchant_url : "https://whatsapp.com/channel/0029VaYb7EyLNSZvA5A4iK2C" }`,
                            },
                          ],
                          messageParamsJson: "",
                        },
            ...
            case "getpp":
              {
                if (Input) {
                  try {
                    ...
                    var ppWong =
                      "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-?q=60";
                  }
                  ryozingod.sendMessage(
                    m.chat,
                    { image: { url: ppWong } },
            ...
            case "self":
              {
                ...
                joreply("ℙ𝔸𝕊ℂℍ𝔸𝕃 𝕍1 𝔹𝕌𝔾 SET TO PRIVATE BOSS");
              }
              break;
            //=================================================//
            case "runtime":
              let runtimetext = ` ℙ𝔸𝕊ℂℍ𝔸𝕃 𝕍1 𝔹𝕌𝔾 Have Been Running For ${runtime(
                process.uptime()
              )}`;
