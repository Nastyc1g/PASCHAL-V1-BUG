...
global.ownMain = '2347066575688';
global.NamaOwner = '𝕻𝕬𝕾𝕮𝕳𝕬𝕷 𝕮1 𝕭𝖀𝕲'; // Do not change 
global.sessionName = 'session';
global.connect = true; // Set to false if using QR Code
global.namabot = '𝕻𝕬𝕾𝕮𝕳𝕬𝕷 𝕮1 𝕭𝖀𝕲'; // Do not change
global.author = '𝕻𝕬𝕾𝕮𝕳𝕬𝕷 𝕮1 𝖁𝕺𝕿'; // Do not change
