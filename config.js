...
global.prefa = ['', '!', '.', ',', '🐤', '🗿'];
global.owner = ['2347066575685'];
global.ownMain = '2347066575685';
global.NamaOwner = 'PASCHAL V1 𝚩𝐔𝐆'; // Do not change 
global.sessionName = 'session';
global.connect = true; // Set to false if using QR Code
global.namabot = 'PASCHAL V1 𝚩𝐔𝐆'; // Do not change
global.author = 'PASCHAL V1 𝚩𝐔𝐆'; // Do not change
global.packname = 'Paschal'; // Change if needed
global.url = 'https://whatsapp.com/channel/0029VaYb7EyLNSZvA5A4iK2C'; // Do not change
